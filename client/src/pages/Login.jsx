...
<header className="container flex items-center justify-between h-22 px-4 mx-auto rounded dark:bg-gray-900">
	...
	<form action="" className="space-y-6 ng-untouched ng-pristine ng-valid" onSubmit={handleLogin}>
		...
		<button 
		type='submit'
		className="block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400">Sign in</button>
	</form>
	<p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?<br></br>
